                    ...
                    <div class="row" id="div1" style="">
						...
						<div class="col-xs-2">
							<div class="form-group">
								...
								<input type="hidden" name="from_project" id="from_project" class="form-control" readonly="readonly" value="<?php echo $_SESSION['logged']['project_id']; ?>">
							</div>
						</div>
						...
						<div class="col-xs-2">
							<div class="form-group">
								<label for="id">To Project </label>
								<select class="form-control" id="to_project" name="to_project" required>
