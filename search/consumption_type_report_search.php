...
<div class="card mb-3">
    <div class="card-header">
        ...
        <button class="btn btn-success linktext"> Type wise Consumption Report </button>
						...
						<td>
							...
							<td>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="to_date" value="<?php if(isset($_GET['to_date'])){ echo $_GET['to_date']; } ?>" name="to_date" autocomplete="off" required >
                                </div>
                            </td>
				...
				<div class="col-sm-12">	
					<center>
						<p>
							...
							<span>Material Type wise consuption Report</span><br>
